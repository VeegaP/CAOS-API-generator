...
export class RegisterComponent implements OnInit {
	...
	userForm = new FormGroup({
		...
		repeatPassword: new FormControl('', [Validators.required, RegisterComponent.passwordsMatchValidator])
	})

	static passwordsMatchValidator(control: FormControl): ValidationErrors {
